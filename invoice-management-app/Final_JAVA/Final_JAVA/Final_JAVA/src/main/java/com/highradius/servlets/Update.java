...
public class Update extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Create an object of the Invoice class with the updated data
        Invoice updatedInvoice = new Invoice(customerOrderId,salesOrg, distributionChannel, 
        		companyCode,orderCreationDate, orderCurrency,customerNumber,
        		amountInUSD,orderAmount	
                       );

        // Create an object of the InvoiceDao and call the updateInvoice method
